...
//checkLiteral();
	...
	
	{
		...
		//String tryString = new String();
		
		// Simplest way to create String
		
		String text = " Hexaware"; //As literals
		
		System.out.println(" The lenght of the text is :"+text.length());
		...
		// concat
		System.out.println("The concatenation can be :"+text.concat("Chennai concated"));
